...
const RecomendadosPage = (props: Props) => {
  ...
  return (
    <>
          ...
          <div className="container-main">
            ...
            <div className="apunte-header">
              <div className="action-buttons">
                ...
                >
                  <AddIcon />
                  {isAddHovered && "Guardar esta recomendacion"}
                </button>
              </div>
            </div>
            {/* //!desde aqui el main */}
            <div className="apunte-body">
              {!edit ? (
                <>
                  <h2 className="title-apunte">{`${data.title}@${data.author}`}</h2>
                </>
              ) : (
      ...
      <React.Fragment>
        ...
        >
          <DialogTitle>{"Copiar a guardados"}</DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
              Este apunte se aparecera en tu seccion de guardados.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
